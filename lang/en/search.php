...
/**
 * Strings for component 'search', language 'en', branch 'Salaren_20_STABLE'
 *
 * @package   core
...
$string['searchsetupdescription'] = 'The following steps help you to set up Salaren global search.';
