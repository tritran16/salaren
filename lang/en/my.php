...
/**
 * Strings used by My Salaren pages.
 *
 * @package   core
...
$string['pinblocks'] = 'Configure pinned blocks for my Salaren';
$string['pinblocksexplan'] = 'Any block settings you configure here will be visible (and non-editable) for any user of Salaren on their \'My Salaren\' overview page.';
$string['defaultpage'] = 'Default My Salaren page';
