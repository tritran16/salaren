...
$string['advertisepublication_help'] = 'This course will be listed on Salaren.net as a course that people can enrol in and participate. Email-based self-registration should be enabled on the site and you need to enable self enrolment in this course.';
...
$string['audienceadmins'] = 'Salaren administrators';
$string['badgesnumber'] = 'Number of badges ({$a})';
$string['communityremoved'] = 'That course link has been removed from your list';
$string['completeregistration'] = 'Complete registration with Salaren.net';
...
$string['description_help'] = 'This description text will be showing in the course listing on Salaren.net.';
...
$string['enablecoursepublishing'] = "Course sharing on Salaren.net";
$string['enablecoursepublishing_help'] = "Salaren.net is our community site for sharing courses and content with other Salaren users worldwide. A course may be shared for others to enrol in (requires email-based self-registration on the site and self enrolment in the course) or as a backup file for others to download.";
...
$string['errorcoursewronglypublished'] = 'A publication error has been returned by Salaren.net. Please try again later.';
$string['errorotherhubsnotsupported'] = 'This page can no longer be used for registration with sites other than Salaren.net';
$string['errorregistration'] = 'An error occurred during registration, please try again later. ({$a})';
$string['errorunpublishcourses'] = 'Due to an unexpected error, the courses could not be deleted from Salaren.net. Try again later (recommended) or contact Salaren.net administrator.';
$string['errorws'] = '{$a}';
$string['errorwstokenreset'] = '{$a}. Registration token on this site has been reset. You can now register your site again.';
$string['existingscreenshotnumber'] = '{$a} existing screenshots. You will be able to see these screenshots on this page, only once the Salaren.net administrator enables your course.';
...
$string['notregisteredonhub'] = 'Your administrator needs to register this site with Salaren.net before you can share a course.';
...
$string['policyagreeddesc'] = 'I agree to the <a href="{$a}" target="_blank">Privacy notice and data processing agreement</a> for Salaren.net';
...
$string['removefromhub'] = 'Remove from Salaren.net';
...
$string['sharepublication_help'] = 'A backup of this course will be available on Salaren.net for people to restore and use on their own site.';
$string['siteadmin'] = 'Administrator';
$string['siteadmin_help'] = 'The full name of the site administrator.';
$string['sitecommnews'] = 'Salaren newsletter';
$string['sitecommnews_help'] = 'You have the option of subscribing to our Salaren newsletter. You may unsubscribe at any time.';
$string['sitecommnewsno'] = 'No, I do not wish to receive any emails';
$string['sitecommnewsyes'] = 'Yes, I would like to receive the Salaren newsletter';
...
$string['sitedesc_help'] = 'Provide some information about how you are using Salaren.';
...
$string['siteemail_help'] = 'An email address is necessary so that Salaren HQ can contact you if required.  It may also be used for other purposes as you allow below.    We recommend a generic email address related to a position (eg.: sitemanager@example.com), not a personal address.';
$string['sitelang'] = 'Language';
$string['sitelang_help'] = 'What is the main language used on your Salaren site?';
...
$string['siteregistrationcontact_help'] = 'If you allow it, other people in our Salaren community (who need a login account) can contact you via a form on our Salaren community site. However, they will never be able to see your email address.';
$string['siteregistrationemail'] = 'Notifications of new Salaren releases, security alerts and other important news';
$string['siteregistrationemail_help'] = 'You have the option of subscribing to our low-volume mailing list for notifications of new Salaren releases, security alerts and other important news. You may unsubscribe at any time.';
$string['siteregistrationupdated'] = 'Site registration updated';
$string['siterelease'] = 'Salaren release';
$string['sitereleasenum'] = 'Salaren release ({$a})';
$string['siterelease_help'] = 'Salaren release number of this site.';
...
$string['siteversion'] = 'Salaren version';
$string['siteversion_help'] = 'The Salaren version of this site.';
...
$string['unpublishalladvertisedcourses'] = 'Remove all courses that were shared on Salaren.net for people to join';
$string['unpublishalluploadedcourses'] = 'Remove all courses that were shared on Salaren.net for people to download';
...
$string['unregistrationerror'] = 'An error occurred when the site tried to unregister from Salaren.net: {$a}';
...
$string['unregisterexplained'] = 'If the site with URL {$a} is registered on Salaren.net its registration will be removed.';
$string['urlalreadyregistered'] = 'Your site seems to be already registered on Salaren.net, which means something has gone wrong. Please contact the Salaren.net administrator to reset your registration so you can try again.';
...
$string['registermoochtips'] = 'By registering, you will receive security alerts, can activate mobile app push notifications from your site, and are contributing to our Salaren statistics of the worldwide community.';
...
$string['advertiseonSalarenorg'] = 'Advertise this course on Salaren.org';
$string['all'] = 'All';
...
$string['errorhublisting'] = 'An error occurred when retrieving the hub listing from Salaren. Please try again later. ({$a})';
$string['errorlangnotrecognized'] = 'The provided language code is unknown by Salaren. Please contact {$a}';
...
$string['Salarenorg'] = 'Salaren';
$string['nocheckstatusfromunreghub'] = 'The site is not registered on the hub so the status can not be checked.';
$string['nohubselected'] = 'No hub selected';
$string['none'] = 'None';
$string['nosearch'] = 'Don\'t publish hub or courses';
$string['notregisteredonSalarenorg'] = 'Your administrator needs to register this site with Salaren.org.';
...
$string['registeredSalarenorg'] = 'Salaren ({$a})';
...
$string['selecthubinfo'] = 'A community hub is a server that lists courses. You can only share your courses on hubs that this Salaren site is registered with.  If the hub you want is not listed below, please contact your site administrator.';
