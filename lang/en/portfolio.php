...
/**
 * Strings for component 'portfolio', language 'en', branch 'Salaren_20_STABLE'
 *
...
$string['format_mbkp'] = 'Salaren backup format';
...
$string['leap2a_feedtitle'] = 'Leap2A export from Salaren for {$a}';
