...
$url = new salaren/_url('/rating/index.php', array('contextid' => $contextid,
                                                 'component' => $component,
...
if (!$ratings) {
    ...
    $table->head = array(
        '',
        html_writer::link(new salaren/_url($sorturl, array('sort' => 'firstname')), $strname),
        html_writer::link(new salaren/_url($sorturl, array('sort' => 'rating')), $strrating),
        html_writer::link(new salaren/_url($sorturl, array('sort' => 'time')), $strtime)
    );
